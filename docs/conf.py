...
# Project information is taken from pyproject.toml and _version.py
try:
...
htmlhelp_basename = 'FlaskIpernityDoc'
...
latex_documents = [(
    master_doc, project, description, author, 'manual'
)]
...
man_pages = [(
    master_doc, project, description, authors, 3
)]
...
#autodoc_mock_imports = ['flask', 'flask_login', 'ipernity']
